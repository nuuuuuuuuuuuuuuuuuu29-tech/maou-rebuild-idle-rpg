...
const completedRecord: ExpeditionRecord = {
  ...
  battleLog: [
    ...
    {
      id: "e2e-boss-encounter-1",
      turn: 0,
      type: "encounter",
      actorName: "村鐘の番人",
      enemyId: "village-warden",
      text: "煤けた境界村で「村鐘の番人」と遭遇した。",
    },
    {
      id: "e2e-boss-attack-1",
      turn: 1,
      type: "allyAttack",
      actorName: "ハイツメ",
      targetName: "村鐘の番人",
      ...
      hpBefore: 28,
      hpAfter: 0,
      text: "ハイツメの攻撃。村鐘の番人に 28 ダメージ。",
    },
    {
      id: "e2e-boss-damage-1",
      turn: 1,
      type: "damage",
      actorName: "村鐘の番人",
      hpBefore: 28,
